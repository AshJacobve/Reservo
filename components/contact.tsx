...
import { Card, CardContent } from "@/components/ui/cardta";
import { Checkbox } from "@/components/ui/checkboxta";
import { Input } from "@/components/ui/inputta";
import { Label } from "@/components/ui/labelta";
      ...
      <div className="mt-24 grid lg:grid-cols-2 gap-16 md:gap-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-12">
          ...
          <div>
            ...
            <Link
              className="font-medium text-primary"
              href="https://maps.app.goo.gl/B9L1y4CFiZvRe7FY6"
              target="_blank"
            >
              Hall Building 110 <br />
            </Link>
          </div>
          <div>
            <div className="h-12 w-12 flex items-center justify-center bg-primary/5 dark:bg-primary/10 text-primary rounded-full">
